...
Version history for this repository (81 releases).
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v4.1.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v4.0.2)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v4.0.1)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v4.0.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.9.2)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.9.1)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.9.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.8.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.7.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.6.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.5.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.4.2)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.4.1)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.4.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.3.3)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.3.2)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.3.1)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.3.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.2.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.1.0)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.0.0)

---

## v3.0.0-alpha: v3.0.0-alpha
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v3.0.0-alpha)
...
- Fix `telnyx` package default timeout and `https` `Agent` default options
- Remove `CallRecordings` resource `bulkDel` method

**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/master...ENGDESK-44134

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.1.1)
...
**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/master...v2.1.0

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.1.00)
...
## What's Changed
- Ensure proper CJS/ESM interop by setting module.exports directly in main entrypoint

**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/master...v2.1.0

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.1.0-beta.1)

---

## v2.1.0-beta.0: v2.1.0-beta.0
**Published:** 2025-08-13
**Pre-release**
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.1.0-beta.0)
...
**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/master...v2.0.1-update

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.1)
...
**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/v1.27.0...v2.0.0


## New Contributors
- @mpareja-godaddy!

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0)

---

## v2.0.0-beta.6: V2.0.0-beta.6
**Published:** 2025-02-04
**Pre-release**
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-beta.6)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-beta.5)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-beta.4)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-beta.3)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-beta.2)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-beta.1)
...
## New Contributors
* @mpareja-godaddy made their first contribution in https://github.com/team-telnyx/telnyx-node/pull/186


**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/v1.27.0...v2.0.0

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-beta.0)

---

## v2.0.0-alpha.7: V2.0.0-alpha.7
**Published:** 2024-10-09
**Pre-release**

## What's Changed
- Export API callbacks `events` type definitions

**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/v1.27.0...v2.0.0

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-alpha.7)

---

## v2.0.0-alpha.6: V2.0.0-alpha.6
**Published:** 2024-10-09
**Pre-release**

## What's Changed
- Update optional types on `Webhooks`
- Make optional types on `Fqdns`, `Ips`, `Messages` and `StorageBuckets` resources creation more strict

**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/v1.27.0...v2.0.0

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-alpha.6)

---

## v2.0.0-alpha.5: V2.0.0-alpha.5
**Published:** 2024-10-09
**Pre-release**

## What's Changed
- Remove `ClientStateUpdate` dupe resource
- Remove `MessagesAlphanumericSenderId` stale resource
- Remove `MessagingHostedNumber` dupe resource
- Remove `MessagingPhoneNumbers` dupe resource
- Remove `MessagingSenderIds` dupe resource
- Remove `PublicKey` stale resource
- Remove `UpdateClientState` dupe resource
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-alpha.5)

---

## v2.0.0-alpha.4: V2.0.0-alpha.4
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-alpha.4)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-alpha.3)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-alpha.2)
...
**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/v1.27...v2.0.0

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-alpha.1)
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v2.0.0-alpha.0)
...
## What's Changed
* init by @ADandyGuyInSpace in https://github.com/team-telnyx/telnyx-node/pull/176
* use correct path for basic calls by @bradrf in https://github.com/team-telnyx/telnyx-node/pull/175

## New Contributors
* @bradrf made their first contribution in https://github.com/team-telnyx/telnyx-node/pull/175

**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/v1.26.2...v1.27.0

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.27.0)

---

## v1.26.2: v1.26.2 10DLC API and Bug Fixes
...
* Bump braces from 3.0.2 to 3.0.3 in /examples/webhook-signing by @dependabot in https://github.com/team-telnyx/telnyx-node/pull/172
* Bump express from 4.18.2 to 4.19.2 in /examples/webhook-signing by @dependabot in https://github.com/team-telnyx/telnyx-node/pull/167
* Fix brand and campaign routes that need to go to /10dlc instead of /v2 by @Craige in https://github.com/team-telnyx/telnyx-node/pull/170
* Init package upgrades by @ADandyGuyInSpace in https://github.com/team-telnyx/telnyx-node/pull/173

## New Contributors
* @dependabot made their first contribution in https://github.com/team-telnyx/telnyx-node/pull/172
* @Craige made their first contribution in https://github.com/team-telnyx/telnyx-node/pull/170

**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/v1.26.1...v1.26.2

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.26.2)

---

## v1.26.1: Fix Porting Comments
**Published:** 2024-03-29

-> Adds comments support for porting orders

## What's Changed
* Fix Porting Comments by @ADandyGuyInSpace in https://github.com/team-telnyx/telnyx-node/pull/168
**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/v1.26.0...v1.26.1

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.26.1)

---

## v1.26.0: v1.26.0 Parity Update + TS Preparation 
...
## What's Changed
* 2.0 update prep by @ADandyGuyInSpace in https://github.com/team-telnyx/telnyx-node/pull/165


**Full Changelog**: https://github.com/team-telnyx/telnyx-node/compare/1.25.5...v1.26.0

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.26.0)

---

## 1.25.5: Fixed Example Security Issues
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/1.25.5)

---

## 1.25.0: Endpoints + Security Fixes
**Published:** 2023-07-19
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/1.25.0)

---

## v1.23.0: Endpoint Updates
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.23.0)

---

## v1.22.0: Additional Verification Support
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.22.0)

---

## v1.21.0: Additional Support for Conference Calls
...
[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.21.0)

---

## v1.20.0: Add support for Porting Orders
**Published:** 2021-09-14

**PortingOrders** support

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.20.0)

---

## v1.18.0: Additional Support for Telephony Credentials (WebRTC)
**Published:** 2021-07-28

Additional Support for Telephony Credentials (WebRTC)

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.18.0)

---

## v1.17.0: Add support for BySMS Verification Codes
**Published:** 2021-07-19

- **SMS Verification** add support for BySMS Verification Codes


[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.17.0)

---

## v1.16.0: Call Queueing Support
**Published:** 2021-07-15

Call queue support

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.16.0)

---

## v1.15.0: New Call-Control Commands
**Published:** 2021-04-26

call control added gather_stop, record_pause, refer, record_resume, transcription_start, transcription_stop


[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.15.0)

---

## v1.14.0-alpha.0: 1.14.0-alpha.0 = Video beta pre-release support
**Published:** 2021-04-23
**Pre-release**

Updates to the SDK to support **beta** video product

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.14.0-alpha.0)

---

## v1.13.1: Hosted messaging support
**Published:** 2021-03-29

Support hosted messaging: https://telnyx.com/resources/hosted-sms-how-to-guide

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.13.1)

---

## v1.13.0: Hosted Messaging Support
**Published:** 2021-03-29

Supports [hosted messaging](https://telnyx.com/resources/hosted-sms-how-to-guide)

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.13.0)

---

## v1.11.0: Telnyx Node SDK v1.11.0
**Published:** 2020-12-18

Add Verify Profiles and Verifications. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.11.0)

---

## v1.10.3: Telnyx Node SDK v1.10.3
**Published:** 2020-12-15

Add Telephony Credentials Resource and fix parsing plain text responses. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.10.3)

---

## v1.10.2: Telnyx Node SDK v1.10.2
**Published:** 2020-10-16

Add support to the Phone Numbers Retrieve method. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.10.2)

---

## v1.10.1: Telnyx Node SDK v1.10.1
**Published:** 2020-09-24

Fix resource constructor call. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.10.1)

---

## v1.10.0: Telnyx Node SDK v1.10.0
**Published:** 2020-08-07

Add support to Messaging Profile Metrics and Short Codes. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.10.0)

---

## v1.9.0: Telnyx Node SDK v1.9.0
**Published:** 2020-07-22

Add support to SIM Card Enable and Disable Methods. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.9.0)

---

## v1.8.0: Telnyx Node SDK v1.8.0
**Published:** 2020-07-14

Add support for the following:
- Wireless new endpoints, OTA Updates, SIM Card Groups, Mobile Operator Networks and SIM Card Network Preferences
- Number Lookup
- Addresses
- Balance
- Faxes

See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.8.0)

---

## v1.7.2: Telnyx Node SDK v1.7.2
**Published:** 2020-04-20

Add support to Inbound Channels, Call Control Application and Outbound Voice Profiles. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.7.2)

---

## v1.7.1: Telnyx Node SDK v1.7.1
**Published:** 2020-02-17

Apply fixes to stateful use of params in resources nested methods. Update webhook examples. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.7.1)

---

## v1.7.0: Telnyx Node SDK v1.7.0
**Published:** 2020-01-30

Add support to Connections, Ips, and FQDNs. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.7.0)

---

## v1.6.0: Telnyx Node SDK v1.6.0
**Published:** 2019-12-18

Add support to Number Order Regulatory Requirements and Number Order Documents. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.6.0)

---

## v1.5.0: Telnyx Node SDK v1.5.0
**Published:** 2019-12-16

Add support to Ip, FQDN, and Credential Connections. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.5.0)

---

## v1.4.0: Telnyx Node SDK v1.4.0
**Published:** 2019-12-12

Add support to Billing Groups. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.4.0)

---

## v1.3.0: Telnyx Node SDK v1.3.0
**Published:** 2019-11-14

Add support to SIM Cards and Phone Numbers. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.3.0)

---

## v1.2.4: Telnyx Node SDK v1.2.4
**Published:** 2019-10-22

fix content-length header calculation on request data. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.2.4)

---

## v1.2.3: Telnyx Node SDK v1.2.3
**Published:** 2019-09-25

Use brackets for array query parameters format. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.2.3)

---

## v1.2.2: Telnyx Node SDK v1.2.2
**Published:** 2019-09-09

fix webhooks signature validation with the [tweetnacl](https://github.com/dchest/tweetnacl-js) library. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.2.2)

---

## v1.2.1: Telnyx Node SDK v1.2.1
**Published:** 2019-09-05

Update webhooks validation algorithm library to js native [tweetnacl](https://github.com/dchest/tweetnacl-js). See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.2.1)

---

## v1.2.0: Telnyx Node SDK v1.2.0
**Published:** 2019-08-19

Add support for nested resources and empty resource constructors. Update Alphanumeric Sender ID endpoints. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.2.0)

---

## v1.1.0: Telnyx Node SDK v1.1.0
**Published:** 2019-08-09

Update webhooks validation algorithm and fix bugs. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.1.0)

---

## v1.0.0: Telnyx Node SDK v1.0.0
**Published:** 2019-08-05

Support for Messaging, Numbers and Call Control. See the [changelog](https://github.com/team-telnyx/telnyx-node/blob/master/CHANGELOG.md) for details.

[View on GitHub](https://github.com/team-telnyx/telnyx-node/releases/tag/v1.0.0)
